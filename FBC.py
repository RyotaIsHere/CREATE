...
❖ › Github  :- RyotaIsHere
❖ › By      :- Ryota-XD
❖ › Tools   :- Create Account Facebook
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛''')


rr = random.choice
PASW = random.choice(["RYOTASTORE","RYOTAISHERE","EREHSIATOYR"])
...
def register_facebook_account(email, password, first_name, last_name, birthday):
    ...
    req['sig'] = ensig
    api_url = 'https://api.facebook.com/method/user.register'
...
for i in range(int(input(f'\n+ Berapa banyak yang ingin di buat? :  '))):
